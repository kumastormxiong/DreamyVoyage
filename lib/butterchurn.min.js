...
;(function() {
  if (typeof window !== 'undefined' && window.butterchurn) {
    var def = window.butterchurn.default;
    if (def && typeof def.createVisualizer === 'function') {
      window.butterchurn.createVisualizer = def.createVisualizer.bind(def);
    }
  }
})();
